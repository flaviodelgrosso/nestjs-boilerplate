...
export class CreateUser1604164774154 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE user (id int NOT NULL AUTO_INCREMENT, email varchar(255) NULL, password varchar(255) NULL, provider varchar(255) NOT NULL DEFAULT 'email', socialId varchar(255) NULL, firstName varchar(255) NULL, lastName varchar(255) NULL, hash varchar(255) NULL, createdAt datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updatedAt datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), deletedAt datetime(6) NULL, photoId varchar(36) NULL, roleId int NULL, statusId int NULL, UNIQUE INDEX UQ_e12875dfb3b1d92d7d7c5377e22 (email), INDEX IDX_9bd2fe7a8e694dedc4ec2f666f (socialId), INDEX IDX_58e4dbff0e1a32a9bdc861bb29 (firstName), INDEX IDX_f0e1b4ecdca13b177e2e3a0613 (lastName), INDEX IDX_e282acb94d2e3aec10f480e4f6 (hash), PRIMARY KEY (id)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE forgot (id int NOT NULL AUTO_INCREMENT, hash varchar(255) NOT NULL, createdAt datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), deletedAt datetime(6) NULL, userId int NULL, PRIMARY KEY (id)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
